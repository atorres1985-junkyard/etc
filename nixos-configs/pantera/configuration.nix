...

{
  ...
  services.xserver = {
    ...
    displayManager = {
      ...
      sddm.enable = true;
      startx.enable = false; # Não funciona para DEs, só para WMs...
      sx.enable = false; # Não funciona para DEs, só para WMs...
      xpra.enable = false;
    ...
    desktopManager = {
      ...
      # wallpaper?
      budgie.enable = true; # Conflicts Pantheon
      cde.enable = false;
      cinnamon.enable = false;
      deepin.enable = false;
      enlightenment.enable = true;
      gnome.enable = false; # Conflicts budgie
      kodi.enable = false;
      lumina.enable = true;
      lxqt.enable = true;
      mate.enable = true;
      ...
      phosh.enable = false;
      plasma5.enable = false; # Crazy conflict
      retroarch.enable = false;
      surf-display.enable = false;
      xfce.enable = false; # cansadinho
      xterm.enable = true;
    };
